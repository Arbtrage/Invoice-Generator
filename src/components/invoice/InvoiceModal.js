...
import { addAsync } from '../../features/invoices/invoiceSlice';
    ...
    <div>
      <Modal show={showModal} onHide={closeModal} size="lg" centered>
        ...
        <div className="pb-4 px-4">
          <Row>
            <Col md={6}>
              <Button variant="primary" className="d-block w-100" onClick={() => addInvoice({ info, currency, total, items, subTotal, taxAmount, discountAmount })}>
